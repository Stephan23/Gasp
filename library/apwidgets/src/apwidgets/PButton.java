...
/**
 * A button. Add instances to {@link apwidgets.PWidgetContainer}.<br>
 * <br>
 ...
 *
 */
public class PButton extends PTextView {
	/**
	 * Creates a button.<br>
	 * 
	 ...
	 * @param text The text on the button's label.
	 */
	public PButton(int x, int y, int width, int height,
			String text) {
		super(x, y, width, height, text);
	}
	/**
	 * Initializes the button. Is called by {@link PWidgetContainer} 
