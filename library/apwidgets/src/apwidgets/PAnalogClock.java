...
/**
 * An analog clock. Add instances to {@link apwidgets.PWidgetContainer}.
 * 
 * @author Rikard Lundstedt
 *
 */
public class PAnalogClock extends PWidget{
	/** Creates an analog clock.
	 * 
	 * @param x The analog clock's x position.
	 * @param y The analog clock's y position.
	 */
	public PAnalogClock(int x, int y) {
	 ...
	 */
	public PAnalogClock(int x, int y, int size) {
		super(x, y, size, size);
	}
	/**
	 * Initializes the analog clock. Is called by {@link PWidgetContainer} 
